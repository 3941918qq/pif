...
<div class="row">
  ...
  <div class="col-sm-12 col-md-12" style="padding:0;">
    <div class="thumbnail">
             <video style="width:100%; " id="video" webkit-playsinline playsinline  poster="<?php preg_match('<img.*?src="(.*?)">',$model->content,$match); 
                        if(isset($match[1])){ echo $match[1];}else{ echo '/img/carousel3.jpg';}?>" controls autoplay="autoplay" muted loop="loop">
...
<script type="text/javascript">
    $(function(){
        ...
        $.post("/course/add-pageview", { uniquekey:uniquekey },
            function(data){             
               if(data.message>0){
    ...
    function subcomment(jump){
        ...
        if(content!=""){
            ...
            $.post("/course/subcomment", { content: content,uniquekey:uniquekey },
            function(data){             
               if(data.message>0){
     ...
     $('#heart').click(function(){
         ...
         $.post("/course/toggle-collect", { flag: flag,uniquekey:uniquekey },
            function(data){  
                console.log(data);
               if(data.message>0){
